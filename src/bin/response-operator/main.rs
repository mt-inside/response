...
#[command(about = "Reconsiles Istio config for cloud-native incident responses", long_about = None)]
struct Args {
    #[arg(short, long)]
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing_subscriber::registry()
        .with(
            filter::Targets::new()
                ...
                .with_target("response_operator", Level::TRACE)
    ...
    version_check::Version::read()
        .iter()
        .for_each(|v| info!(version = %v, "Rustc"));
